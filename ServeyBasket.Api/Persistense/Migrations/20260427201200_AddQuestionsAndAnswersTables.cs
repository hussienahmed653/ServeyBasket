        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Contant = table.Column<string>(type: "nvarchar(1000)", maxLength: 1000, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<int>(type: "int", nullable: false),
                    Contant = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
                    IsActive = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Answers_QuestionsId_Contant",
                table: "Answers",
                columns: new[] { "QuestionsId", "Contant" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Questions_PollId_Contant",
                table: "Questions",
                columns: new[] { "PollId", "Contant" },
                unique: true);
